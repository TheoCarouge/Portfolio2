...
const shadowHeader = () => {
    ...
    // When scroll is > 50 viewport height, add shadow-header class to the header tag
...
const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_cuwhf1i','template_iuqb27d','#contact-form','ig_Ibj9v4oS8e8_LD')
        .then(() => {
            // Show sent message
            contactMessage.textContent = 'Le message à bien été envoyé ✅'
...
const scrollUp = () =>{
    ...
    // When the scroll is higher than 350 viewport height, add show-scroll class to tag with the scrollup class
